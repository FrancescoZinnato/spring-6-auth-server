...
public class SecurityConfig {
    ...
    public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http)
            throws Exception {
        // Trovare una soluzione nuova -> prima: OAuth2AuthorizationServerConfiguration.applyDefaultSecurity(http)  dopo: http.with(OAuth2AuthorizationServerConfigurer.authorizationServer(), Customizer.withDefaults())
